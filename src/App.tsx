...
void loop() {
  ...
  if (chosenDirection == 0) {
    ...
    chosenDirection = leftDistance > rightDistance ? 1 : -1;
    turnCount = 0;
  }
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-navy-900/80 backdrop-blur-sm border-2 border-gold-400/30 p-6 min-h-[300px] flex flex-col shadow-xl">
            {isEditing && isAdmin ? (
              <textarea
        ...
        <div className="lg:col-span-8 flex flex-col h-full min-h-[500px]">
          ...
          <div className="flex-1 border-2 border-t-0 border-gold-400 bg-navy-950/90 relative group">
            {isEditing && isAdmin ? (
              <textarea
...
export default function App() {
  ...
  loadScript('https://cdnjs.cloudflare.com/ajax/libs/three.js/r121/three.min.js')
    ...
    .then(() => {
      ...
      if (!vantaEffect.current && vantaRef.current && VANTA && THREE?.PerspectiveCamera) {
  ...
  return (
    <div className="min-h-screen font-sans text-slate-200 selection:bg-gold-400 selection:text-navy-950 pb-20">

      {/* Vanta Birds — fixed full-screen canvas behind everything */}
      <div
        ref={vantaRef}
      ...
      <div
        className="fixed inset-0 pointer-events-none opacity-20 bg-[radial-gradient(circle_at_50%_50%,rgba(245,158,11,0.1),transparent_70%)]"
        style={{ zIndex: 1 }}
      />

      <header
        className="max-w-7xl mx-auto px-4 pt-16 pb-8 mb-16 border-b-4 border-gold-400 flex flex-col md:flex-row justify-between items-baseline gap-8"
        ...
        <div>
          ...
          <div className="mt-8 space-y-2">
            <p className="text-sm font-bold tracking-[0.4em] uppercase text-gold-600">
              ...
              <a href="/Robot_Competition_Guidelines_and_Mechanics.pdf"
              target="_blank"
      ...
      >
        ...
        {isAdmin && (
          <section id="share-links" className="mt-40 p-10 bg-black/80 backdrop-blur-sm border-4 border-gold-400 border-double">
            ...
            <div className="mt-8 flex items-start gap-4 p-4 bg-navy-950/80 border-l-4 border-gold-400">
